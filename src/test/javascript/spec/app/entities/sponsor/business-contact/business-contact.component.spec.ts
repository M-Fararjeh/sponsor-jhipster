...
import { BusinessContactComponent } from 'app/entities/sponsor/business-contact/business-contact.component';
...
describe('Component Tests', () => {
  describe('BusinessContact Management Component', () => {
    let comp: BusinessContactComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BusinessContactComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.businessContacts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
