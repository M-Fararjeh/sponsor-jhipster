...
import { BusinessActivityComponent } from 'app/entities/sponsor/business-activity/business-activity.component';
...
describe('Component Tests', () => {
  describe('BusinessActivity Management Component', () => {
    let comp: BusinessActivityComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BusinessActivityComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.businessActivities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
